...
API_ID = int(environ.get('21781923'))
API_HASH = environ.get('c3ab0edd9dff3197d014cd5c64098bf4')
BOT_TOKEN = environ.get('6273715153:AAGkh6ZAQ1LKZymz-mFKbqFBrmSUMhN3W4Q')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5370516281',).split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001853013879').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1001852013808')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mrstrange2004:Ishwar61@cluster0.0ooozfj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Mrstrange2004")
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001876956817'))
